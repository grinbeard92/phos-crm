...
import { type InvoicePdfData } from '../types/pdf-data.types';
...
const styles = StyleSheet.create({
  ...
  title: {
    ...
    marginBottom: 10,
    color: '#d73737', // Red accent for invoice
  },
  subtitle: {
    fontSize: 12,
    color: '#666',
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.totalsSection}>
          ...
          {data.amountPaid &&
            data.amountPaid.amountMicros > 0 && (
              <View style={styles.totalsRow}>
                <Text style={styles.totalsLabel}>Amount Paid:</Text>
                <Text style={styles.totalsValue}>
                  {formatCurrency(
                    data.amountPaid.amountMicros,
                    data.amountPaid.currencyCode,
                  )}
                </Text>
              </View>
            )}
          ...
          {data.amountDue && (
            <View style={styles.amountDueRow}>
              ...
              <Text style={styles.totalsValue}>
                {formatCurrency(
                  data.amountDue.amountMicros,
                  data.amountDue.currencyCode,
                )}
              </Text>
            </View>
          )}
        ...
        <Text style={styles.footer}>
          Thank you for your business! | Generated by Phos CRM | Please remit
          payment by due date
        </Text>
      </Page>
    </Document>
