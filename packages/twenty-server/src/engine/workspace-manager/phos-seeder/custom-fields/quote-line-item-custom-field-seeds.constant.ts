...
/**
 * QuoteLineItem fields per Epic 001 specification
 * Note: 'name' field is auto-created by Twenty (used as line item description)
 */
export const QUOTE_LINE_ITEM_CUSTOM_FIELD_SEEDS: FieldMetadataSeed[] = [
  {
  ...
  },
  {
    ...
    name: 'sortOrder',
    icon: 'IconArrowsSort',
    description: 'Order of line items on the quote',
  },
];
